...
// Find the index number of the first instance of 'ee' in the string and add ot to the msg variable
...
// Find the first instance of 'me' in the string and replace iut with a w character and add it to the msg variable
