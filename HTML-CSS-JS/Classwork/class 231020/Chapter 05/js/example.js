...
list.insertBefore (newItemFirst, list.firstChild);          // Add element to list before the first <li> element
...
var newHeading = headingText + '<span>' + totalItems + '</span>';   // Update h2 using innerHTML (not textContent) because it contains markup
